...
export default function Page() {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-stone-200 border-b-2 border-stone-400 p-4">
          ...
          <button
            ...
            className={`px-3 py-1 text-xs sm:px-4 sm:py-2 sm:text-sm lg:px-6 lg:py-2 lg:text-base font-semibold rounded-md transition-colors border font-[family-name:var(--font-geist-mono)] min-h-[40px] ${
              info.title === button.title
                ...
                : "bg-transparent text-stone-800 border-stone-500 hover:text-stone-600"
            }`}
      ...
      <div className="mt-5 p-4 bg-stone-200 border border-stone-300 rounded-sm flex flex-col space-y-4 lg:space-y-0 lg:flex-row lg:items-start lg:space-x-6">
        ...
        <div className="flex flex-col space-y-2 text-center lg:text-left">
          <h2 className="text-lg font-bold text-stone-700">{info.title}</h2>
          <p className="text-stone-800 font-semibold">{info.price}</p>
          <div
